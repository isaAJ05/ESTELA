...
La solución construida respeta, sin ampliarlo ni reducirlo, el alcance fijado en la Sección 3. Se trata de un prototipo para un único usuario, validado sobre un conjunto delimitado de cuatro ejercicios de complejidad controlada, con la precisión de la comparación de movimiento y la latencia por etapa como criterios de aceptación medidos y no como subproducto. La Sección 9 documenta, componente por componente, la evidencia que sostiene esa arquitectura dentro del mismo alcance y del mismo presupuesto de tiempo, y deja señaladas las validaciones que todavía faltan (9.10) antes de dar por cerrada cada decisión.
