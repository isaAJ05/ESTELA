...
RUTA_MODELO = Path(
    r"C:\Users\USUARIO\Downloads\Prueba2\DATASET\resultados\mediapipe_coords\modelo.h5"
)
RUTA_NORMALIZACION = Path(
    r"C:\Users\USUARIO\Downloads\Prueba2\DATASET\resultados\mediapipe_coords\normalizacion.npz"
)
